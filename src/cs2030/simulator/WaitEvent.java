...
public class WaitEvent extends Event {
    ...
    public static Pair<Shop, Event> func(Customer customer, int serverID, Shop shop) {
        ...
        if(opServer.isPresent()) {
            ...
            Server newserver = new Server(server.getID(), false, true, server.getNextAvailableTime()+1);
    ...
    public String toString(){
        return String.format("%.3f ", this.getEventStartTime()) + this.getCustomer().getID() + " waits to be served by " + this.serverID;
    }
}
